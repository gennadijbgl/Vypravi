...
public class FragmentAdminMain extends Fragment implements View.OnClickListener {
    ...
    public   final  static String frgmTag = "FragmentAdminMain";

    final  static int CHOOSE_PIC = 96;

    @Bind(R.id.bChangePicture)
    Button mChange;
    ...
    @Bind(R.id.edit_user)
    TextView tf;
    @Bind(R.id.imageUserPic)
    CircleImageView im;
    @Bind(R.id.textHello)       TextView textHello;

    @Bind(R.id.bUsers)          Button mUsers;

    public FragmentAdminMain() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        im.setImageBitmap(ActivityFactory.getMainActivity().getCurrentUser().getBitmapInView(im));
        ...
        mUsers.setOnClickListener(new View.OnClickListener() {
            ...
            getMainActivity().openFragment(iMainActivity.Fragments.Users,false);
            }
        });
